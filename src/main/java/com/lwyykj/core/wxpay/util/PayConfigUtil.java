...
public class PayConfigUtil {
	public static final String APP_ID = "xxxxxx";// 微信开发平台应用ID(公众号ID)
	public static final String MCH_ID = "xxxx";// 商户号(商户号ID)
	public static final String API_KEY = "c15xxxxxxxx";// API key(商户号里面的)

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="take-delivery">
			<div class="status">
				<img src="../images/T13iv.XiFdXXa94Hfd-32-32.png" class="icon"/>
				<h2>您已成功付款</h2>
				<div class="successInfo">
					<ul>
						<li>实付金额<em>¥${total}</em></li>
						<div class="user-info">
					...
					<div class="option">
						...
						<a href="/order/orderList" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
						<a href="/" class="J_MakePoint"><span>回到首页</span></a>
					</div>
				</div>
				<div class="take_img">
